...
the
[unit testing guide](/products/splashkit/documentation/splashkit-expansion/02-writing-unit-tests)
...
Open the MINGW64 terminal and install prerequisites with these commands:
